...
class Generator(nn.Module):
  def __init__(self, G_ch=64, dim_z=128, bottom_width=4, resolution=128,
               G_kernel_size=3, G_attn='0', n_classes=100,
               ...
               G_init='N02', skip_init=False, no_optim=True,
               G_param='SN', norm_style='bn',
               **kwargs):

    if kwargs['G_nl'] == 'inplace_relu':
    ...
    print('self.bottom_width', self.bottom_width)
...
class Discriminator(nn.Module):
  ...
  def __init__(self, D_ch=64, D_wide=True, resolution=128,
               ...
               D_init='N02', skip_init=False, D_param='SN', AC=False, **kwargs):
    if kwargs['D_nl'] == 'inplace_relu':
      G_activation=nn.ReLU(inplace=True)
