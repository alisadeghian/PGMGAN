...
def main():
    ...
    if args.show_clusters:
        ...
        if 'CIFAR100' in config['data']['train_dir']:
            get_dataset_name = 'cifar100'
        elif 'CIFAR' in config['data']['train_dir']:
            get_dataset_name = 'cifar10'
        elif 'stl10' in config['data']['train_dir']:
            get_dataset_name = 'stl10'
        else:
            get_dataset_name = 'webp'
